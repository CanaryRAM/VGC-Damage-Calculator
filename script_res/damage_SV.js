...
function CALCULATE_ALL_MOVES_SV(p1, p2, field) {
    ...
    checkEmbodyAspect(p1, p2);
    checkEmbodyAspect(p2, p1);
    checkDownload(p1, p2);
    checkDownload(p2, p1);
    ...
    var valorATp1 = p1.boosts[AT];
    if (valorATp1) {
        $(".p1-attack-mods").html('&check;');
    } else {
        $(".p1-attack-mods").empty();
    }
    var valorDFp1 = p1.boosts[DF];
    if (valorDFp1) {
        $(".p1-defense-mods").html('&check;');
    } else {
        $(".p1-defense-mods").empty();
    }
    var valorSDp1 = p1.boosts[SD];
    if (valorSDp1) {
        $(".p1-specialdefense-mods").html('&check;');
    } else {
        $(".p1-specialdefense-mods").empty();
    }
    ...
    var valorATp2 = p2.boosts[AT];
    if (valorATp2) {
        $(".p2-attack-mods").html('&check;');
    } else {
        $(".p2-attack-mods").empty();
    }
    var valorDFp2 = p2.boosts[DF];
    if (valorDFp2) {
        $(".p2-defense-mods").html('&check;');
    } else {
        $(".p2-defense-mods").empty();
    }
    var valorSDp2 = p2.boosts[SD];
    if (valorSDp2) {
        $(".p2-specialdefense-mods").html('&check;');
    } else {
        $(".p2-specialdefense-mods").empty();
    }
